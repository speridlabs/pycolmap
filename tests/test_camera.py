...
class TestCamera(unittest.TestCase):
    ...
    def test_distortion_params(self):
        ...
        self.assertEqual(len(dist_params or []), 0)
        ...
        dist_params = camera.get_distortion_params()
        self.assertEqual(len(dist_params or []), 4)
        self.assertEqual((dist_params or [])[0], 0.1)    # k1
        self.assertEqual((dist_params or [])[1], 0.01)   # k2
        self.assertEqual((dist_params or [])[2], 0.001)  # p1
        self.assertEqual((dist_params or [])[3], 0.0001) # p2
